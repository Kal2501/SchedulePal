...
$offset = ($page - 1) * $limit;
$total_data = countUserSchedules($conn, $NIM); 
$total_pages = ceil($total_data / $limit);
$schedules = getUserSchedulesWithLimit($conn, $NIM, $limit, $offset);
    ...
    <div class="content">
                    ...
                    <div class="right">
                        <div class="date-times">
                            <p>
                                ...
                                <?php echo htmlspecialchars(date('d-m-Y', strtotime($schedule['tanggal']))); ?>
                            </p>
                            <p>
                                ...
                                <?php echo htmlspecialchars(date('H:i', strtotime($schedule['waktu']))); ?>
                            </p>
                        </div>
                        <div class="aksi">
                            <a class="edit" href="edit.php?id=<?php echo $schedule['id_acara']; ?>">Edit</a>
                            <a class="delete" href="profile.php?delete=1&id=<?php echo $schedule['id_acara']; ?>" onclick="return confirm('Are you sure you want to delete this schedule?')">Delete</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
        ...
        <div class="bottom-container">
            ...
            <div class="pagination">
                <?php tampilkanHalamanuser($page, $total_pages); ?>
            </div>
        </div>
    </div>
    <?php
